...
var CURRICULUM = [
  { month: 1, units: [
    { icon: "🧩", module: "プレフォニックス", title: "パズル（トピックレッスン）", desc: "文字なし・絵と音でCATを覚える", href: "puzzle.html", color: "#9B95D5" },
  ...
  { month: 4, units: [
    { icon: "🚢", module: "フォニックス2", title: "ブレンディング", desc: "sh + ip = ship", href: "blending.html", color: "#06AED5" }
  ]},
  { month: 5, units: [
    { icon: "🚢", module: "フォニックス2", title: "ブレンディング（復習）", desc: "sh + ip = ship", href: "blending.html", color: "#06AED5" }
  ]},
  { month: 6, units: [
    { icon: "📖", module: "フォニックス3", title: "センテンスリーディング", desc: "The shop sells fresh fish from the ship.", href: "sentence-reading.html", color: "#FFC43D" }
  ]},
  { month: 7, units: [] },
  { month: 8, units: [] },
  { month: 9, units: [] },
